...
@EnableJpaRepositories("ru.innopolis.rinatgumarov.selfdevelopment.repository")
...
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() throws PropertyVetoException, IOException {
        ...
        entityManagerFactory.setPackagesToScan("ru.innopolis.rinatgumarov.selfdevelopment.model");
